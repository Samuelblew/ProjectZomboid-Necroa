-- Define constantes para os tipos de reparo de máscara.
local NONE = "None";
local CLOTH = "Cloth";
local FILTER = "Filter";
local WASH = "Wash";
...
-- Enumeração dos tipos de reparo disponíveis para máscaras.
...
-- Tabela principal que define todos os itens de máscara reconhecidos pelo mod.
-- Cada entrada pode ter durabilidade, tipo de reparo e, opcionalmente, qualidade.
SusceptibleMaskItems = {
--- Hazmat Suits --- 
    SCBA_notank	=                                                { durability=600, repairType=OXYGEN },
    SCBA =                                                { durability=600, repairType=OXYGEN },
...
--- Gas masks ---
    Hat_BuildersRespirator =                              { durability=400, repairType=FILTER },
    Hat_ImprovisedGasMask =                               { durability=400, repairType=FILTER },
...
--- Surgical, dust and face masks ---
	Hat_SurgicalMask =                               { durability=120, repairType=WASH },
...
--- Bandanas & cloth masks ---
	...
	ClothMask =                                                 { durability=26, repairType=WASH },
...
-- Função que retorna os dados da máscara para um item fornecido.
-- Procura pelo ID completo (modID.tipo) e, se não encontrar, pelo tipo do item.
