...
-- Configurações
local ADD_THRESHOLD = 7
local REMOVE_THRESHOLD = 12
...
local RULES = {
    { FULLTYPE = "FZ3.FZ2",  TEXTURES = { "F_ZedBody01_level1", "F_ZedBody01_level2", "F_ZedBody01_level3" } },
    { FULLTYPE = "FZ3.FZ21", TEXTURES = { "F_ZedBody02_level1", "F_ZedBody02_level2", "F_ZedBody02_level3" } },
    { FULLTYPE = "FZ3.FZ22", TEXTURES = { "F_ZedBody04_level1", "F_ZedBody04_level2", "F_ZedBody04_level3" } },
    { FULLTYPE = "FZ3.FZ23", TEXTURES = { "F_ZedBody03_level1", "F_ZedBody03_level2", "F_ZedBody03_level3" } },
}
