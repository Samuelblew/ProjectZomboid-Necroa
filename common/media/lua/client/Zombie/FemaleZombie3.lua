...
-- Configurações
local ADD_THRESHOLD = 12
local REMOVE_THRESHOLD = 21
...
local RULES = {
    { FULLTYPE = "FZ3.FZ3",  TEXTURES = { "F_ZedBody01_level1", "F_ZedBody01_level2", "F_ZedBody01_level3" } },
    { FULLTYPE = "FZ3.FZ31", TEXTURES = { "F_ZedBody02_level1", "F_ZedBody02_level2", "F_ZedBody02_level3" } },
    { FULLTYPE = "FZ3.FZ32", TEXTURES = { "F_ZedBody04_level1", "F_ZedBody04_level2", "F_ZedBody04_level3" } },
    { FULLTYPE = "FZ3.FZ33", TEXTURES = { "F_ZedBody03_level1", "F_ZedBody03_level2", "F_ZedBody03_level3" } },
}
