...
-- Configurações
local ADD_THRESHOLD   = 5   -- ativa
local REMOVE_THRESHOLD = 7  -- desativa
...
local RULES = {
    { FULLTYPE = "FZ3.MZ1",  TEXTURES = { "M_ZedBody01_level1", "M_ZedBody01_level2", "M_ZedBody01_level3" } },
    { FULLTYPE = "FZ3.MZ11", TEXTURES = { "M_ZedBody02_level1", "M_ZedBody02_level2", "M_ZedBody02_level3" } },
    { FULLTYPE = "FZ3.MZ12", TEXTURES = { "M_ZedBody04_level1", "M_ZedBody04_level2", "M_ZedBody04_level3" } },
    { FULLTYPE = "FZ3.MZ13", TEXTURES = { "M_ZedBody03_level1", "M_ZedBody03_level2", "M_ZedBody03_level3" } },
}
