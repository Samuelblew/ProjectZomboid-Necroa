...
-- Configurações
local ADD_THRESHOLD   = 7   -- ativa
local REMOVE_THRESHOLD = 12  -- desativa
...
local RULES = {
    { FULLTYPE = "FZ3.MZ2",  TEXTURES = { "M_ZedBody01_level1", "M_ZedBody01_level2", "M_ZedBody01_level3" } },
    { FULLTYPE = "FZ3.MZ21", TEXTURES = { "M_ZedBody02_level1", "M_ZedBody02_level2", "M_ZedBody02_level3" } },
    { FULLTYPE = "FZ3.MZ22", TEXTURES = { "M_ZedBody04_level1", "M_ZedBody04_level2", "M_ZedBody04_level3" } },
    { FULLTYPE = "FZ3.MZ23", TEXTURES = { "M_ZedBody03_level1", "M_ZedBody03_level2", "M_ZedBody03_level3" } },
}
